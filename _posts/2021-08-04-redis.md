...
#指定配置文件启动
docker run -itd --restart=always -p 6379:6379 --name redis -v /home/redis/redis.conf:/etc/redis/redis.conf -v /home/redis/data:/data redis /etc/redis/redis.conf --appendonly yes
